...
- There are also some apps and websites that use this data:
    ...
    - embermitre uses Make Me a Hanzi animations in Hanping Chinese Dictionary: [Google Play Store](https://play.google.com/store/apps/details?id=com.embermitre.hanping.app.pro) and [App Store](https://apps.apple.com/us/app/hanping-chinese-dictionary/id6755623311), and Hanping Cantonese Dictionary: [Google Play Store](https://play.google.com/store/apps/details?id=com.embermitre.hanping.cantodict.app.pro) and [App Store](https://apps.apple.com/us/app/hanping-cantonese-dictionary/id6755623391)
